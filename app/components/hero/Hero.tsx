...
const Hero = () => {
  return (
    <>
      <section className="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')] h-[600px]">
        ...
        <div className="bg-gradient-to-b dark:opacity-80   from-blue-20 to-transparent dark:from-blue-900 w-full mt-[75px] h-[600px] absolute top-0 left-0 "></div>
      </section>
    </>
  );
};
